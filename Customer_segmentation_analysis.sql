...
In this project, I used SQL to extract and analyze data from the customer table. The table contains 
information about customers, such as their user_id, gender, age, salary, and purchase history (1 or 0).
